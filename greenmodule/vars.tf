...
# bastion sg requiring access to green security group
variable "bastion_remote_sg_id" {
}

# bastion subnet CIDR requiring access to green subnets 
variable "bastion_subnet_CIDR" {
}

variable "app_green_sg_id" {
}
